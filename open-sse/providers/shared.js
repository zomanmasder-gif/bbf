...
// OAuth clients - use env vars in production
...
export const GOOGLE_OAUTH_CLIENT = {
  clientId: process.env.GOOGLE_OAUTH_CLIENT_ID || "REDACTED",
  clientSecret: process.env.GOOGLE_OAUTH_CLIENT_SECRET || "REDACTED",
};
